...
//	if (((jaarNu - jaar) == 10 && maand == maandNu && dag < dagNu) || ((jaarNu - jaar) == 10 && maand < maandNu)){ // gebruiker wel al jarig geweest in het jaar
//		jaar -= 1;
//		maand -= 1;
//	}
...
//	if (maand == maandNu && dag < dagNu){ // jarig in huidige maand, maar nog niet jarig geweest of nog niet jarig geweest in het jaar
