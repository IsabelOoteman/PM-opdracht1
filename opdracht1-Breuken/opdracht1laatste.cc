...
int main (){
	...
	if (maand > 12 or !er worden letters ingegeven!){ // getal hoger dan aantal maanden die in een jaar kunnen zitten
	...
	if (dag > 31 or !er worden letters ingegeven!){ // getal hoger dan aantal dagen die in een maand kunnen zitten
		cout << "Dit is niet mogelijk" << endl;
		return 1;
	}
